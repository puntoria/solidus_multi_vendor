...
Deface::Override.new(
  ...
  text: <<-HTML
          <%= f.field_container :price, class: ['form-group'] do %>
            <%= f.label :price, raw(I18n.t('spree.master_price') + content_tag(:span, ' *', class: "required")) %>
...
#                   <%= f.label :vendor_id, I18n.t('spree.vendor') %>
#                   <%= f.collection_select(:vendor_id, @vendors, :id, :name, { include_blank: I18n.t('spree.match_choices.none') }, { class: 'select2' }) %>
