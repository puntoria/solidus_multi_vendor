      ...
      module ProductsControllerDecorator
        ...
        def stock
          ...
          @stock_locations = Spree::StockLocation.accessible_by(current_ability,
            :read).where(vendor_id: @product.vendor_id)
          if @stock_locations.empty?
            flash[:error] = I18n.t('spree.stock_management_requires_a_stock_location')
...
Spree::Admin::ProductsController.prepend SolidusMultiVendor::Spree::Admin::ProductsControllerDecorator
