...
describe Spree::Variant do
  ...
  describe '#assign_vendor' do
    ...
    context 'product not vendorized, variant vendorized' do
      before do
        SolidusMultiVendor::Config[:vendorized_models] = ['variant']
      end

      after do
        SolidusMultiVendor::Config[:vendorized_models] = SolidusMultiVendor::Configuration::DEFAULT_VENDORIZED_MODELS
      end
    ...
    context 'product vendorized, variant not vendorized' do
      before do
        SolidusMultiVendor::Config[:vendorized_models] = ['product']
      end
